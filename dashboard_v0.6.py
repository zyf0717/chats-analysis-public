...
def parse_data(contents):
    ...
    if contents is not None:
        ...
        if 'text' in str(content_type).lower():
        ...
        # Uncomment either line below to anonymize users
        # df.User = [f'User {x}' for x in df.User.factorize()[0]]
